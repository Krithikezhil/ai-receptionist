...
export default async function DashboardPage() {
  ...
  const [businessProfile, businessHours, services] = await Promise.all([
  ...
  return (
    <div className="flex flex-1 flex-col items-center gap-6 bg-zinc-50 px-6 py-10 dark:bg-black">
      <div className="flex w-full max-w-2xl flex-col gap-6">
        ...
        <p className="text-sm text-zinc-500 dark:text-zinc-500">
          This is the M3 organization/business configuration foundation. Calling, AI conversations,
          leads, appointments, and billing are not implemented yet — see{" "}
